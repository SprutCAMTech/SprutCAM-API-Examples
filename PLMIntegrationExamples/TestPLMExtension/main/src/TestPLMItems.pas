...
uses
  System.SysUtils, IDL.SprutCAMTech.STPLMInterface;
...
begin
  inherited Create;
  // В случае, если нужно дочернюю сущность в дереве определённого типа.
  case AType of
    itNone: TestInit; // Если нет, создаём сущности всех видов.
